...
@section('content')
        ...
        <main class="">
            <div class="flex flex-row">
                <div class="container mx-auto py-45 px-5 text-[#008DD5] flex flex-col items-start gap-3">
                    <div class="inline-block">
                        {{-- Titulo de la empresa --}}
                        <h1 class="font-['Bebas_Neue'] text-5xl md:text-[100px] leading-tight tracking-[0.04em]">belocomputacion</h1>
                ...
                {{-- Carrusel ofertas --}}
                <div class=" px-5 py-5 md:px-25 md:py-27">
                    
                    <div class="container relative overflow-hidden w-full h-128 md:w-[500px] md:h-[500px] bg-[#3a3d4c] rounded-lg hover:scale-105 transition-transform duration-300 ">
                        ...
                        x-init="setInterval(() => {
                            ...
                            class="py-6">
                        {{-- BADGE --}}
                            <p class="absolute top-2 left-1/2 -translate-x-1/2 items-center rounded-md bg-gradient-to-r from-blue-400 to-pink-500 px-3 py-2 text-xs md:font-medium text-white inset-ring inset-ring-blue-400/30"> 🔥 OFERTAS 🔥</p>
                            {{-- Botones --}}
                            ...
                            @foreach ($oferta as $index => $computadora)
                                ...
                                <div x-show="recorrido === {{ $index }}" x-transition class=" absolute w-full h-full flex flex-col items-center justify-center ">
                                    ...
                                    <a href="{{ route('computadoras.show', $computadora->slug) }} " class="w-full h-full flex flex-col items-center justify-center ">
                                        ...
                                        <p class="pb-6 text-gray-300 font-bold text-sm md:text-lg">{{ $computadora->nombre }} - ${{ number_format($computadora->precio, 2) }}</p>
