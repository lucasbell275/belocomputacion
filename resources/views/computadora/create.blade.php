...
@section('content')
    <main class=" md:mx-10 px-6 py-12 max-w-full min-h-screen text-white">
        ...
        <div class="mb-8 flex flex-col justify-center text-center">
            ...
            <span class="block mx-auto h-1 w-28 bg-[#008DD5] mt-2 rounded-full"></span>
            <p class="text-gray-400 text-sm mt-2">Completá los datos técnicos y comerciales para publicar un nuevo equipo.
            </p>
        </div>
        ...
        <form action="{{ route('computadoras.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="bg-gray-900/60 backdrop-blur-md border border-white/10 p-6 md:p-8 rounded-2xl shadow-xl space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder=""
                            required>
                    </div>

                    <div class="space-y-2">
                        <label for="slug" class="block text-sm font-semibold text-gray-300">Slug</label>
                        <input type="text" id="slug" name="slug" value="{{ old('slug') }}" placeholder=""
                            required>
                    </div>
            ...
            <div class="bg-gray-900/60 backdrop-blur-md border border-white/10 p-6 md:p-8 rounded-2xl shadow-xl space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="almacenamiento" name="almacenamiento" value="{{ old('almacenamiento') }}"
                            placeholder="">
                    </div>
                    ...
                    <div class="space-y-2">
                        <label for="motherboard" class="block text-sm font-semibold text-gray-300">Placa Madre
                            (Motherboard)</label>
                        <input type="text" id="motherboard" name="motherboard" value="{{ old('motherboard') }}"
                            placeholder="">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="bateria" name="bateria" value="{{ old('bateria') }}"
                            placeholder="">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-900/60 backdrop-blur-md border border-white/10 p-6 md:p-8 rounded-2xl shadow-xl space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" id="precio" name="precio" value="{{ old('precio') }}" placeholder=""
                            required>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" id="stock" name="stock" value="{{ old('stock') }}" placeholder=""
                            required>
                    </div>

                    <div class="space-y-2 md:col-span-2 flex flex-col justify-end">
                        <label for="imagen" class="block text-sm font-semibold text-gray-300 mb-1">Imagen de la
                            computadora</label>
                        <p class="text-[11px] text-gray-400 mb-1">Formatos recomendados: JPG, PNG, WEBP. Peso máximo: 2MB.
                        </p>
                        <label for="imagen"
                            class="cursor-pointer bg-gray-800 border border-white/10 rounded-lg px-4 py-3 hover:bg-gray-700 transition block text-center text-sm text-gray-300">
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-white/10">
                    <input type="checkbox" id="oferta" name="oferta" value="1"
                        {{ old('oferta') ? 'checked' : '' }} class="w-5 h-5 accent-[#008DD5] rounded cursor-pointer">
            ...
            <div class="flex justify-end pt-4">
                <button type="submit"
                    class="bg-[#008DD5] hover:bg-[#006fa3] text-white font-bold rounded-xl py-3 px-8 transition-all duration-300 shadow-lg cursor-pointer">
