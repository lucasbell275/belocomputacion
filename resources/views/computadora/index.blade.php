        ...
        <div class="grid md:grid-cols-3 gap-6 md:gap-20 pt-6 text-center md:min-w-full items-start p-6">
            ...
            @foreach ($computadora as $computadoras)
                    ...
                    <div class="bg-[#3a3d4c] rounded-xl p-6 py-8  hover:border-2 hover:border-sky-500 transition-all duration-300 flex flex-col gap-1 font-semibold  text-gray-300 pt-2  ">  
                        ...
                        <a class="font-bold text-[16px] bg-white rounded-lg py-2 text-black md:w-sm mt-auto py-2 px-4 md:mx-auto  text-center hover:bg-[#006fa3] transition-colors duration-300" href="{{route('computadoras.show', $computadoras->slug)}}"> Ir a la publicacion</a>
            ...
            <form action="{{route('computadoras.index')}}" method="GET" class=" flex flex-row" >
                <div class="flex flex-col px-2 gap-2">
                    <label for="precioMin" class="text-gray-300 bg-transparent">
                        Precio minimo
                        <input type="number" id="precioMin" name="precioMin" class="[appearance:textfield] [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none bg-transparent border border-gray-600 hover:border-[#008DD5] focus:border-[#008DD5] rounded-lg outline-none px-1">
                    </label>

                    <label for="precioMax" class="text-gray-300 bg-transparent">
                        Precio maximo
                        <input type="number" id="precioMax" name="precioMax" class="[appearance:textfield] [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none bg-transparent border border-gray-600 rounded-lg hover:border-[#008DD5] focus:border-[#008DD5] outline-none px-1">
                    </label>
                </div>
                <button type="submit" class="font-bold text-[12px] md:text-[16px] bg-white rounded-lg py-2 text-black md:w-1/16 px-2 text-center hover:bg-[#006fa3] transition-colors duration-300">Filtrar</button>
