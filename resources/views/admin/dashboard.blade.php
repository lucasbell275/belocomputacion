    ...
    <main class="text-white">
            ...
            <section class="flex-1 px-10 py-8 ">
                <div class="mb-8 flex flex-col gap-4 md:flex md:items-center md:justify-between md:flex-row ">
                    ...
                    <div class="rounded-md  border border-white/10 bg-white/5 px-3 py-3 text-sm text-[#008DD5] font-semibold">
                        <p>{{ auth()->user()->name }}</p>
                ...
                <div class="flex flex-col mt-8 rounded-lg border border-white/10 bg-[#373F51] p-3 py-10 gap-5">
                    <h2 class="py-3 text-3xl font-bold text-[#008DD5] border-b-5 border-gray-700 tracking-wide">PANEL PRINCIPAL</h2>
