    ...
    <main class="p-4">
        <div class="text-gray-300 flex flex-col gap-4 p-4 bg-[#373F51] ">
            <div class="flex flex-col gap-3">
                ...
                <p class="bg-[#008DD5]/20 text-[#008DD5] rounded-full px-3 py-1 text-md w-fit">Razon: {{$intentoContacto -> razon}}</p>
            </div>
            <div>
                <div class="bg-[#444E65] border-l-4 border-[#008DD5] pl-4 py-4" >
