<header class="bg-[#373F51] shadow-[0_10px_20px_rgba(0,0,0,0.007)] border-b-1 border-white/3 sticky top-0 z-50 w-full relative ">
    <nav class="container mx-auto flex flex-wrap items-center justify-between py-3 px-4">
        <!-- Logo -->
        ...
        <form action="{{route('computadoras.index')}}" method="GET" class="hidden peer-checked:block md:flex peer-checked:w-full">        
            <input class="buscador font-bold text-[16px] bg-white rounded-lg py-2 text-black w-sm mt-auto  px-4 mx-auto outline-hidden " placeholder="Buscar computadoras..." type="text" name="buscar">
