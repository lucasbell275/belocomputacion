    ...
    <div class= "flex flex-col px-4 md:flex md:flex-row md:gap-4 md:justify-between md:px-4">
        <div class="grid grid-cols-2 gap-4 pt-5 md:pl-25 md:pt-20">
            <div class="flex items-center justify-center w-24 h-12">
                <img class="max-w-full max-h-full object-contain" src="{{asset('images/footer/msi.png')}}" alt="MSI">
            </div>
            <div class="flex items-center justify-center w-24 h-12">
                <img class="max-w-full max-h-full object-contain" src="{{asset('images/footer/nvidia.png')}}" alt="NVIDIA">
            </div>
            <div class="flex items-center justify-center w-24 h-12">
                <img class="max-w-full max-h-full object-contain" src="{{asset('images/footer/amd.png')}}" alt="AMD">
            </div>
            <div class="flex items-center justify-center w-24 h-12">
                <img class="max-w-full max-h-full object-contain" src="{{asset('images/footer/intel.png')}}" alt="Intel">
            </div>
        </div>

        {{-- SECCIONES --}}
        <div class="gap-2 text-center pt-10 pb-4 md:pl-25 ">
            <p class="mt-4 mb-4 text-[#008DD5] font-bold text-medium leading-none justify-center ">SECCIONES</p>
        ...
        <div class="flex flex-col items-center justify-center">
            <p class="mt-4 mb-2 text-[#008DD5] font-bold text-medium leading-none">Nuestra ubicación</p>
            <p class="px-6 gap-2 text-white">
                <iframe class="mb-3"src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3281.582393757801!2d-58.47088600000001!3d-34.665248!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcc95dad8d2d93%3A0x69a468701e79ad6f!2sAv.%20Casta%C3%B1ares%204600%2C%20C1439%20Cdad.%20Aut%C3%B3noma%20de%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1778013996887!5m2!1ses-419!2sar" width="full md:350" height="250" style="border:0  ;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </p>
        </div>
    </div>
